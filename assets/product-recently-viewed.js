...
Shopify.Products = (function () {
  ...
  var cookie = {
    ...
    write: function (recentlyViewed) {
      document.cookie =
        ...
        "; expires=" +
        new Date(
          Date.now() + this.configuration.expires * 24 * 60 * 60 * 1000,
        ).toUTCString() +
        "; path=" +
  ...
  var finalize = function () {
    ...
    let csWrap = document.querySelector(
      ".header-cart-wrapper .cross-sell-wrapper",
    );
    let rcvItemsBox = document.querySelector(
      ".header-cart-wrapper .recently-viewed-content",
    );
    let csItemsBox = document.querySelector(
      ".header-cart-wrapper .cross-sell-content",
    );
    ...
    let clrcvItemsBox = document.querySelector(
      ".cart-left .recently-viewed-content",
    );
